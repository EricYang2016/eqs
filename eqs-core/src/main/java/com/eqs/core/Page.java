...
public class Page<T> implements Serializable {
    ...
    public Page(List<T> entities, int pageNo, int pageSize, int entityCount) {
    ...
    public Page(int pageSize, int pageNo, int entityCount) {
    ...
    public Page(int pageSize, long firstEntityIndex, int entityCount) {
