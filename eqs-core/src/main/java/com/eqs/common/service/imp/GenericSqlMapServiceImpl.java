package com.eqs.common.service.imp;

import com.eqs.common.page.BasePagination;
import com.eqs.common.service.GenericService;
 ...
 * @since 1.0.0.0
 */
public abstract class GenericSqlMapServiceImpl<T extends com.eqs.common.entity.BaseEntity, ID extends Serializable>
        implements GenericService<T, ID> {

    @Autowired
    protected com.eqs.common.dao.DaoMapper<T, ID> dao;
