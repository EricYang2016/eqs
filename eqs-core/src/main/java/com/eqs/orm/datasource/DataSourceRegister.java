 ...
 */
package com.eqs.orm.datasource;

import com.alibaba.druid.pool.DruidDataSource;
import com.alibaba.druid.util.JdbcUtils;
import com.eqs.common.SafeKit;
import com.eqs.common.SafeKit;
...
public class DataSourceRegister implements ImportBeanDefinitionRegistrar, EnvironmentAware {
    ...
    public static final String prefix = "eqs.datasource";
        ...
        for (String dsId : allDataSourceNames) {
            ...
            if(dataSource instanceof DruidDataSource){
                try {
                    ...
                    //fix 8小时不使用连接断开问题
                    String dbType = JdbcUtils.getDbType(druidDataSource.getRawJdbcUrl(),null);
